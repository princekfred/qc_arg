...
def parse_args(argv=None):
    ...
    parser.add_argument("--active-electrons", type=int, default=6, help="Active electrons.")
    parser.add_argument("--active-orbitals", type=int, default=6, help="Active orbitals.")
