...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=3.0,
        help="H-H spacing in Angstrom for linear H6.",
    )
    parser.add_argument(
        "--basis",
        type=str,
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional metrics plot image path (default: h6_error_plot.png). "
...
def _plot_metrics(
    ...
    ax1.set_title("H6 ADAPT/QSC-EOM Metrics vs ADAPT Iteration")
    ...
    fidelity_ax.set_title("H6 Overlap Fidelity vs ADAPT Iteration")
...
def main():
    ...
    reports = ["===== H6 Ground-State ADAPT-VQE ====="]
    iterations = []
    adapt_errors = []
    qsceom_errors = []
    adapt_max_gradients = []
